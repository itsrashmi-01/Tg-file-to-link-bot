...
async def clone_conversation_handler(client: Client, message: Message):
    ...
    if step == "WAIT_TOKEN":
        ...
        # --- START BOT IMMEDIATELY (Without Channel) ---
        ...
        try:
            ...
            text = (
                ...
                "**Final Step: Connect Database Channel**\n"
                "1. Create a **Private Channel**.\n"
                "2. Add your bot (@{bot_info.username}) to that channel as an **Admin**.\n"
                "3. Go to that channel and send the command: `/connect`\n"
                "4. The bot will automatically detect the ID and link it.\n\n"
                "__Wait for the 'Connected' confirmation message in your channel.__"
            )
